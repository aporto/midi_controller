...
// Pin where the fist midi push button is connected
// All other buttons shall be connected on the subsequent pins
// e.g.: If PIN_FIRST_BUTTON is 10, then the software will consider
// that the second button is connected to pin 11, 
// third button is connected to pin 12, and goes on
#define PIN_FIRST_BUTTON 30
